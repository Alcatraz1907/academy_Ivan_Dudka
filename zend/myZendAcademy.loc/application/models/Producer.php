 ...
 * Time: 23:06
 */
class Application_Model_Producer{
    ...
    {
        $this->_dbTable = new Application_Model_DbTable_Producers();
        if ($id) {
    ...
    public function getAllProducers()
    {
        $select = $this->_dbTable->select(Zend_Db_Table::SELECT_WITH_FROM_PART)
            ...
            ->join('nationalities','producers.nationality_id = nationalities.id');
        //die($select);
    ...
    public function getAllProducerForForm(){
